...
async function init()
{
    ...
    if(isDevMode)
    {
        ...
        await retry(() => db.query('REPLACE INTO Permission (authorityId, resourceGroupId) VALUES("user", "email-gateway/*")'), { max_tries : 50 }); // Add generic wildcard permissions for the service
    }
